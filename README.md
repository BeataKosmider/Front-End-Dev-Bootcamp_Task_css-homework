...
kolor czcionki na całej stronie (body) to #3f3f3f

Umieść teraz po jednej sztuce H1 oraz H2 w ciele strony.

5. Stwórz diva, który dla rozdzielczości mobilnych (do 768px) ma szerokość 94% i zawsze jest wycentrowany w poziomie. Spraw, aby na większych ekranach (powyżej 768px) zmienił swoją szerokość na 640px. Nie dodawaj reset.css.
...
```
cd existing_repo
git remote add origin https://gitlab.portal.futurecollars.com/beata_kosmider/css-homework.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.portal.futurecollars.com/beata_kosmider/css-homework/-/settings/integrations)
